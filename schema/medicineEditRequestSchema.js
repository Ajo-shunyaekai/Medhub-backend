...
const NewMedicineEdit = EditMedicine.discriminator(
  "new_medicine",
  newMedicineEditRequestSchema
);
...
const SecondaryMarketMedicineEdit = EditMedicine.discriminator(
  "secondary_medicine",
  secondaryMarketMedicineEditRequestSchema
);
