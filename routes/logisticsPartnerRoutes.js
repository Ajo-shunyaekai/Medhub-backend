...
router.get("/get-logistics-list", checkAuthorization, checkCommonUserAuthentication, getLogisticsList);
router.get("/get-logistics-details", checkAuthorization, checkCommonUserAuthentication, getLogisticsDetails);
