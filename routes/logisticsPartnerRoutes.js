...
const { addLogisticsPartner, login, getLogisticsList, 
    getLogisticsDashboardData, getLogisticsDetails, 
    updateLogisticsRequest } = require('../controller/LogisticsPartner');
...
router.post("/get-logistics-dashboard-data", checkAuthorization, checkCommonUserAuthentication, getLogisticsDashboardData);
...
router.post("/update-logistics-details", checkAuthorization, checkCommonUserAuthentication, updateLogisticsRequest);
