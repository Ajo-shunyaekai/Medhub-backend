  ...
  validation: (reqObj, type) => {
    ...
    const requiredFields = {
      ...
      addNewProduct: [
        ...
        {
          field: "registered_in",
          message: "Registered Countries are required",
        },
        ...
        {
          field: "est_delivery_days",
          message: "Estimated Delivery Days are required",
        },
      ],
      addSecondaryProduct: [
        { field: "supplier_id", message: "Supplier ID is required" },
        ...
        {
          field: "country_available_in",
          message: "Country available in is required",
        },
        {
          field: "min_purchase_unit",
          message: "Min purchase unit is required",
        },
        // { field: 'composition', message: 'Composition is required' },
        { field: "strength", message: "Strength is required" },
        { field: "type_of_form", message: "Type of form is required" },
      ...
      buyerRegister: [
        ...
        {
          field: "buyer_name",
          message: "Buyer Company name field is required",
        },
        ...
        {
          field: "buyer_country_code",
          message: "Supplier mobile Field is required",
        },
        {
          field: "contact_person_name",
          message: "Contact person name Field is required",
        },
        { field: "designation", message: "Designation Field is required" },
        {
          field: "contact_person_email",
          message: "Contact person email Field is required",
        },
        {
          field: "contact_person_mobile",
          message: "Contact person mobile Field is required",
        },
        {
        ...
        },
        {
          ...
          message: "Country of origin Field is required",
        },
        {
        ...
        {
          field: "approx_yearly_purchase_value",
        ...
        // { field: 'tax_no', message: 'Tax no Field is required' },
        {
          ...
          message: "Registration no Field is required",
        },
      ...
      supplierRegister: [
        ...
        { field: "supplier_name", message: "Company name field is required" },
        {
          ...
          message: "Suppplier address field is required",
        },
        // { field: 'supplier_email', message: 'Supplier email Field is required' },
        {
          field: "supplier_mobile_no",
          message: "Supplier mobile Field is required",
        },
        { field: "description", message: "Description Field is required" },
        // { field: "license_no", message: "License no Field is required" },
        ...
        {
          field: "categories",
          message: "Trade In Categories Field is required",
        },
        {
          field: "registration_no",
          message: "Registration no Field is required",
        ...
        // { field: 'payment_terms', message: 'Payment Terms Field is required' },
        {
          ...
          message: "Supplier country code  Field is required",
        },
        {
          field: "contact_person_country_code",
          message: "Contact person country code  Field is required",
